...
The 10 simulators include BindsNET, hxtorch, jaxsnn, Lava-DL, Nengo, Norse, Rockpool, Sinabs, snnTorch, and Spyx.
...
| --------------- | :--: | :--: | :------: |
| [BindsNET](https://github.com/BindsNET/bindsnet) | ✓ | ✓ | [BindsNET examples](https://neuroir.org/docs/examples/bindsnet/nir-conversion/) |
